                  ...
                  <div className="shadow-lg rounded-lg overflow-hidden h-[540px] pb-16 w-full lg:h-96 relative bg-gray-800 bg-opacity-50 backdrop-blur-lg">
                    <div className="p-4 lg:p-6 h-full flex flex-col justify-between">
                      ...
                      <div className="absolute bottom-4 left-0 right-0"> {/* Positioning for fixed bottom */}
                        ...
                        <div className="text-center flex flex-col sm:flex-row sm:justify-center sm:gap-4">
                          <a href={project.html_url} target="_blank" rel="noopener noreferrer">
                            <button className="bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg py-2 px-4 transition-all duration-300 lg:w-28">
                              GitHub
                            </button>
                          </a>
                          {project.homepage && (
                            <a href={project.homepage} target="_blank" rel="noopener noreferrer">
                              <button className="bg-green-600 hover:bg-green-700 text-white rounded-lg py-2 px-4 mt-2 sm:mt-0 transition-all duration-300 lg:w-28">
                                Live Demo
                              </button>
                            </a>
                          )}
